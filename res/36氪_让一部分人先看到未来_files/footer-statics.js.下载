...
$(document).ready(function () {
  ...
  var chuangtouUrlArr = ['//rong.36kr.com', '//insight.36kr.com', '//research.36kr.com']
  var meitiUrlArr = ['//36kr.com', '//qiye.36kr.com', '//chuang.36kr.com/huodong', '//chuang.36kr.com/report']
  var chuangtouMail = 'service_chuangtou@36kr.com'
  var meitiMail = 'service_media@36kr.com'
  var service = 'service@36kr.com'
  var catchType
//                    <a href="mailto:service@36kr.com">service@36kr.com</a>
  $.each(chuangtouUrlArr, function (i, el) {
    if (url.indexOf(el) > -1) {
      catchType = chuangtouMail;
    }
  })
  if (!catchType) {
    $.each(meitiUrlArr, function (i, el) {
      if (url.indexOf(el) > -1) {
        catchType = meitiMail;
      }
    })
  ...
  var replacedom = document.querySelector('#J_servemail');
  if(replacedom) replacedom.innerHTML = '<a href="mailto:' + catchType + '">' + catchType + '</a>'
